...
const navigationItems = [
  { name: 'Dashboard', href: '/', icon: Home },
         ...
         { name: 'Field Mapping', href: '/mapping', icon: Navigation },
         { name: 'Advanced Mapping', href: '/advanced-mapping', icon: Target },
         { name: 'GEE Satellite', href: '/gee-mapping', icon: Satellite },
  { name: 'IoT Monitoring', href: '/iot', icon: Activity },
  { name: 'Simple IoT', href: '/simple-iot', icon: Smartphone },
